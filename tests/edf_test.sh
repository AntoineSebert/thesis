...
printf "data/0 :\n"
python src/main.py -a edf -f svg -o cumulated_free -s 10 --case data/0 > tests/test0.svg

printf "data/1 :\n"
python src/main.py -a edf -f svg -o cumulated_free -s 10 --case data/1 > tests/test1.svg

printf "data/2 :\n"
python src/main.py -a edf -f svg -o cumulated_free -s 10 --case data/2 > tests/test2.svg

printf "data/3 :\n"
python src/main.py -a edf -f svg -o cumulated_free -s 10 --case data/3 > tests/test3.svg

printf "data/4 :\n"
#python src/main.py -a edf -f svg -o cumulated_free -s 10 --case data/4 > tests/test4.svg & # too long ?

printf "data/5 :\n"
python src/main.py -a edf -f svg -o cumulated_free -s 10 --case data/5 > tests/test5.svg

printf "data/6 :\n"
python src/main.py -a edf -f svg -o cumulated_free -s 10 --case data/6 > tests/test6.svg
